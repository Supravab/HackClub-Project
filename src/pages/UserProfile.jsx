...
>>>>>>> 7d449bc7ec48a703998b8cb19d18f2e42b3fe6bc
      ...
      <div className="page-container">
        <div className="content-wrapper">
          ...
          <div className="profile-card">
            ...
            <div className="profile-info">
              <h2>
                Username: <span className="highlight">{userData.name}</span>
              </h2>
              <h3>
                Email: <span className="highlight">{userData.email}</span>
              </h3>
              <h3>
                Age: <span className="highlight">{userData.age}</span>
              </h3>
              <h3>
                Category: <span className="highlight">{userData.category}</span>
              </h3>
            </div>
          </div>
          ...
          <div className="tabs-container">
            {['join', 'sessions'].map((tab) => (
              ...
              >
                {tab === 'join' ? 'Create Sessions' : 'Scheduled Sessions'}
              </button>
            ))}
          </div>
        ...
        <div className="content-wrapper">
          ...
          <div className="tabs-container">
            {['join', 'sessions'].map((tab) => (
              ...
              >
                {tab === 'join' ? 'Diagnosis Result' : 'Private Sessions'}
              </button>
            ))}
          </div>
